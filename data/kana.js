...
// Bildstöd (dual coding-teorin): en emoji som visuellt ankare per bastecken,
// matchad mot minnesbilden. Tenten/kombinationer är regelbaserade och saknar bild.
const KANA_EMOJI = {
  'あ':'📡','い':'🧊','う':'🔭','え':'🦜','お':'🐍',
  'か':'🪃','き':'🔑','く':'🐦','け':'🍪','こ':'🛖',
  'さ':'✂️','し':'🎣','す':'🌀','せ':'🦷','そ':'🪡',
...
for (const c of [...HIRAGANA, ...KATAKANA]) c.e = KANA_EMOJI[c.k] || null;
